...
function ServerMapFolder( $resourceType, $folderPath, $sCommand )
{
	...
	if ( $sErrorMsg != '' )
		SendError( 1, "Error al crear el directorio \"{$sResourceTypePath}\" ({$sErrorMsg})" ) ;
...
EOF;
	...
	switch ($errorNumber )
	{
		...
		case 1 :	// Custom error.
			...
			break ;
		case 201 :
			$msg = 'Ya existe un imagen con ese nombre. La imagen subida ha sido renombrada a "' . $fileName . '"' ;
			break ;
		case 202 :
			$msg = 'Imagen no válida' ;
			break ;
		default :
			$msg = 'Error al subir la imagen. Nro.: ' + $errorNumber ;
			break ;
	}
